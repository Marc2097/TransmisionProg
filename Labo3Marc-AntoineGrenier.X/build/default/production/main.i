...
unsigned int lectureADC(unsigned char canal);
unsigned char trouveChiffre(unsigned int anX, unsigned int anY);
...
int g_indexChiffre=0;
unsigned char g_loto[4] = {1,2,3,4};
